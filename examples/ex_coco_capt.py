"""
EX_COCO_CAPT
Test of new COCO caption tools.
...
def get_pretrained_net():
    ...
    #modules = list(pretrained.children())
...
def main():
    ...
    # Get models
    cnn_net = get_pretrained_net()
    capt_model = image_caption.COCOEncoder(
        cnn_net,
        len(wmap)
    )

    # Get a trainer
    trainer = image_capt_trainer.COCOCaptTrainer(
        capt_model,
        # training parameters
